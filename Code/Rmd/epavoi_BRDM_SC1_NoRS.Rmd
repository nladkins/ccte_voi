...
if (shiny::isRunning()){ params$progress$set(value=0.11) }
...
```{r prior}
if (shiny::isRunning()){ params$progress$set(value=0.21) }
#---------------------------#
...
```{r posterior A pt1}
if (shiny::isRunning()){ params$progress$set(value=0.37) }
#------------------------#
...
if (shiny::isRunning()){ params$progress$set(value=0.42) }
...
```{r posterior B pt1}
if (shiny::isRunning()){ params$progress$set(value=0.53) }
#------------------------#
...
```{r posterior B pt2}
if (shiny::isRunning()){ params$progress$set(value=0.63) }
t.IC=t.B
posterior.realized.information.summary.df=NULL
for.local.ETSC=NULL
TSC.true.mat=NULL
...
```{r output AB}
if (shiny::isRunning()){ params$progress$set(value=0.74) }
#--------#
# OUTPUT #
#--------#
...
```{r plot_RS, echo=FALSE}
if (shiny::isRunning()){ params$progress$set(value=0.84) }
...
```{r Outputting_Input}
if (shiny::isRunning()){ params$progress$set(value=0.95) }
