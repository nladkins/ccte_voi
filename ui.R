...
shinyUI(
  fluidPage(
   ...
   tabsetPanel(id="tabs",
               type = "tabs",
               tabPanel(title="Decision Rules and Prior Uncertainty",
                        ...
                        fluidRow(
                          column(
                            ...
                            radioButtons(
                              ...
                              selected = 1), bsTooltip(id = "decisionRule", title = "How the decision maker implements the exposure reduction."),
                            ...
                            radioButtons(
                              ...
                              selected = 1), bsTooltip(id = "RS_included", title = "Whether to include response surface analysis."), 
                            
                            numericInput(inputId = "TRL",
                            ...
                            bsTooltip(id = "TRL", title = "Target risk level (log\U2081\U2080) used by TRDM. For fatal outcome TRL is defined over lifetime, while it is given per day for acute outcomes."),
                             ...
                             numericInput(
                              ...
                              tabPanel(title="Toxicity Testing Information",
                                       value="toxicity_testing",
                              ...
                              tabPanel(title="Economic Parameters",
                ...
                fluidRow(
                  ...
                  column(width = 2, 
                         ...
                         tags$br(),
                         disabled(downloadButton("download_report", "Download Report", style="background-color:#5cb85c;color:white; font-size:small")),
                         tags$br(),
                         bsButton(
                           ...
                           icon = icon("edit"),
                           block = FALSE
                         ), bsTooltip(id = "generateReport", title = "Click to generate a report.", placement = "top")
                  )
                  ),
